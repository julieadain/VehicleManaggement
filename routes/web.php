...
Route::post("/storeEmail", "ProfileController@storeEmail");
Route::get("/changeAddress", "ProfileController@changeAddress");
Route::post("/storeAddress", "ProfileController@storeAddress");
...
Route::get("/adminPaymentCreate", "PaymentController@adminPaymentCreate")->name('payment.adminPaymentCreate');
