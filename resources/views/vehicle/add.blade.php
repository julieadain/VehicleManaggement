            ...
            @endif
                ...
                <form action="{{url('vehicle')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="brand" value=" {{old('brand')}}" class="form-control" id="inputBrand" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="model" value=" {{old('model')}}" class="form-control" id="exampleInputModel" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="color" value=" {{old('color')}}" class="form-control" id="exampleInputColor" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="reg_number" value=" {{old('reg_number')}}" class="form-control" id="exampleInputRegNum" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" name="reg_date" value=" {{old('reg_date')}}" class="form-control" id="exampleInputRegYear" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name="seat_capacity" value=" {{old('seat_capacity')}}" class="form-control" id="exampleInputCapacity" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputAc" class="col-sm-2 control-label">AC/Non-AC</label>
                        <div class="col-sm-6">
                            <select name="ac" value=" {{old('ac')}}" class="form-control">
